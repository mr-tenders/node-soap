...
NamespaceScope.prototype.getNamespaceURI = function(prefix, localOnly) {
  switch (prefix) {
    ...
    default:
      let nsUri = this.namespaces[prefix];
      /*jshint -W116 */
      if (nsUri != null) {
        return nsUri.uri;
...
NamespaceScope.prototype.getNamespaceMapping = function(prefix) {
  switch (prefix) {
    ...
    default:
      let mapping = this.namespaces[prefix];
      /*jshint -W116 */
      if (mapping != null) {
        return mapping;
      } else if (this.parent) {
...
NamespaceContext.prototype.pushContext = function() {
  let scope = new NamespaceScope(this.currentScope);
...
NamespaceContext.prototype.declareNamespace = function(prefix, nsUri) {
  if (this.currentScope) {
    let mapping = this.currentScope.getNamespaceMapping(prefix);
